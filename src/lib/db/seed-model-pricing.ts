 ...
 * Grok Imagine is billed in `units` at $0.01 (Quality 1K ≈ 5, 2K ≈ 7) — not
 * the pricing-API "compute seconds" lie (#1069). Edit endpoints share the
 * sibling t2i unit/price so a reference-image still has a row.
 */
